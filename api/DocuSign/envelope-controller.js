...
const sendEnvelopeController = async (req, res) => {
  ...
  envelopeDef.emailBlurb = 'Attached here, is a document sent from AGI100. Please sign.'
  ...
  envelopeDef.recipients = docusign.Recipients.constructFromObject({signers: [signer]});
  ...
  try {
    results = await createEnvelopePromise(accountId, {'envelopeDefinition': envelopeDef})
  } catch  (e) {
